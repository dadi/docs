...
### Changing the sign-in page background
...
To redefine a variable, create a file named `custom.css` within the `workspace/public` directory and set the value of each variable in the `body` selector.
