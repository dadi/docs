...
For example, the image of the Harry Potter movie we uploaded above could be used as the poster image in a document representing the movie as well as in a document representing Emma Stone. Whilst the former could contain more generic metadata properties, the latter might require specific specific caption and crop coordinates to highlight Hermione.
